<template>
  <div ref="wrapper" class="list-wrapper">
    <div class="scroll-content" :class="{scrollX: isscrollX}" >
      <slot>
...
<script>
  ...
  import { getRect } from 'core/context'
  ...
  export default {
    ...
    computed: {
      ...
      isscrollX() {
        return this.freeScroll || this.direction === 'horizontal'
      }
    },
    created() {
    ...
    methods: {
      initScroll() {
        ...
        options = Object.assign(options, this.moreOptions)
      ...
      _reboundPullDown() {
        const {stopTime = 0} = this.pullDownRefresh
