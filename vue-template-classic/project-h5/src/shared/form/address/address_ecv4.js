  ...
  import Vue from 'vue'
    export default {
      ...
      async created(){
        let code = this.$route.query.metauiJson ? this.$route.query.metauiJson : 'address_ecv4'
    ...
    methods: {
        async loadCfg(prj, code) {
          ...
          try{
              ...
              res = require('./address_ecv4.metaui.json')
        ...
        init_g(res) {
          ...
          this.metauiJsonClass = ['address_ecv4', res.code]
